...
export default function CartContextProvider({ children }) {
  ...
  function updateCartItemeCount(id,count){
    let data = {
      count: count
    }
  ...
  return (
    <CartContext.Provider value={{ getUserCart, numsCartItems,setNumsCartItems, addUserCart, deleteUserCart, clearUserCart, updateCartItemeCount }}>
         {children}
